                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                  <div className="hover-scale" style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start', cursor: 'pointer' }}>
                    ...
                    <div>
                      ...
                      <p style={{ color: '#94a3b8', lineHeight: '1.6', fontSize: '0.95rem' }}>Promac Technologies Pvt. Ltd.<br />Sapthagiri Nagar, Puzhuthivakkam<br />(near Redington), Chennai - 600091</p>
                    </div>
                  </div>
